...
var commandFlags = map[string][]string{
	...
	AuditMvn: {
		url, user, password, apikey, accessToken, sshPassPhrase, sshKeyPath, serverId, ExcludeTestDeps, InsecureTls,
	},
	AuditGradle: {
		url, user, password, apikey, accessToken, sshPassPhrase, sshKeyPath, serverId, ExcludeTestDeps, UseWrapper,
	},
