...
func init() {
	...
	JfrogUser = flag.String("jfrog.user", "", "JFrog platform  username")
	JfrogPassword = flag.String("jfrog.password", "", "JFrog platform password")
	...
	JfrogAccessToken = flag.String("jfrog.adminToken", "eyJ2ZXIiOiIyIiwidHlwIjoiSldUIiwiYWxnIjoiUlMyNTYiLCJraWQiOiJ2MUFpWkIySDFMakllYXY2aHRoRXZST1NHYktpM2N3b3IwbEgtX0h4ZnBnIn0.eyJzdWIiOiJqZmZlQDAwMFwvdXNlcnNcL21pY2hhZWxzdiIsInNjcCI6ImFwcGxpZWQtcGVybWlzc2lvbnNcL2FkbWluIGFwaToqIiwiYXVkIjoiKkAqIiwiaXNzIjoiamZmZUAwMDAiLCJpYXQiOjE2Mzg4Nzg3NjksImp0aSI6IjNmYjNmMTg5LTIzMGItNDcyNy1hYTQ2LTZiOGQ3NDJlYzczMCJ9.Y_RHsiATL1T0qMBVJU3U307x9H-Nsbgv_rsIE-gG1CiTyoS2h5vWVajkLS3JmfJ6LwWWt1D7l7Tygsh1ccQ_g3x-Ih1pfcDvEgl__gQAq1ahk005rJGL9qKy8ckO7BWHNSJFf9Tvb--zYyKAIVlejSzMJaV7ZstgTE8VFvSiRazL7pFZHPnGw4lJm7qn8r5MJUEoqtwEZAvfsre7lwhjcyudXCjjrt2QOt_0BHs_00hV48nrc79CIHecDnUx2urJbkfYilPmXeCz8pKZhIt9zEqQdy4CfvLdX72hIQ8HRsIgMmCrIlZHB47bxZugecuSX7K63hFc3mhsNrhWMC-zpQ", "JFrog platform admin token")
	TestArtifactory = flag.Bool("test.artifactory", true, "Test Artifactory")
	TestArtifactoryProject = flag.Bool("test.artifactoryProject", true, "Test Artifactory project")
