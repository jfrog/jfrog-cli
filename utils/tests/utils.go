...
func init() {
	...
	ContainerRegistry = flag.String("rt.containerRegistry", "localhost:8082", "Container registry")
	ContainerRegistryTag = flag.String("rt.containerRegistryTag", "artifactory:8082", "Container registry tag")
