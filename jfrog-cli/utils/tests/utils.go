...
func init() {
	...
	DockerRepoDomain = flag.String("rt.dockerRepoDomain", "10.1.16.109:8081/docker-local", "Docker repository domain")
	DockerTargetRepo = flag.String("rt.dockerTargetRepo", "docker-local", "Docker repository domain")
