...
func TestBuildPromote(t *testing.T) {
	...
	buildInfo := inttestutils.GetBuildInfo(artifactoryDetails.Url, tests.RtBuildName1, buildNumberA, t, artHttpDetails)
...
func TestArtifactoryBuildCollectEnv(t *testing.T) {
	...
	buildInfo := inttestutils.GetBuildInfo(artifactoryDetails.Url, tests.RtBuildName1, buildNumber, t, artHttpDetails)
