	...
	return cliutils.GetSortedCommands(cli.CommandsByName{
		{
			...
			Aliases:      []string{"s"},
			Usage:        corecommon.ResolveDescription(status.GetDescription(), status.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("pl status", corecommon.ResolveDescription(status.GetDescription(), status.GetAIDescription()), status.Usage),
		...
		},
		{
			...
			Aliases:      []string{"t"},
			Usage:        corecommon.ResolveDescription(trigger.GetDescription(), trigger.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("pl trigger", corecommon.ResolveDescription(trigger.GetDescription(), trigger.GetAIDescription()), trigger.Usage),
		...
		},
		{
			...
			Aliases:      []string{"v"},
			Usage:        corecommon.ResolveDescription(version.GetDescription(), version.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("pl version", corecommon.ResolveDescription(version.GetDescription(), version.GetAIDescription()), version.Usage),
			BashComplete: corecommon.CreateBashCompletionFunc(),
			Action:       getVersion,
		},
		{
			...
			Aliases:      []string{"sy"},
			Usage:        corecommon.ResolveDescription(sync.GetDescription(), sync.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("pl sync", corecommon.ResolveDescription(sync.GetDescription(), sync.GetAIDescription()), sync.Usage),
		...
		},
		{
			...
			Aliases:      []string{"ss"},
			Usage:        corecommon.ResolveDescription(syncstatus.GetDescription(), syncstatus.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("pl sync-status", corecommon.ResolveDescription(syncstatus.GetDescription(), syncstatus.GetAIDescription()), syncstatus.Usage),
			ArgsUsage:    common.CreateEnvVars(),
			BashComplete: corecommon.CreateBashCompletionFunc(),
