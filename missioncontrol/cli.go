	...
	return cliutils.GetSortedCommands(cli.CommandsByName{
		{
			...
			Usage:        corecommon.ResolveDescription(licenseacquire.GetDescription(), licenseacquire.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("mc license-acquire", corecommon.ResolveDescription(licenseacquire.GetDescription(), licenseacquire.GetAIDescription()), licenseacquire.Usage),
		...
		},
		{
			...
			Usage:        corecommon.ResolveDescription(licensedeploy.GetDescription(), licensedeploy.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("mc license-deploy", corecommon.ResolveDescription(licensedeploy.GetDescription(), licensedeploy.GetAIDescription()), licensedeploy.Usage),
		...
		},
		{
			...
			Usage:        corecommon.ResolveDescription(licenserelease.GetDescription(), licenserelease.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("mc license-release", corecommon.ResolveDescription(licenserelease.GetDescription(), licenserelease.GetAIDescription()), licenserelease.Usage),
		...
		},
		{
			...
			Usage:        corecommon.ResolveDescription(jpdadd.GetDescription(), jpdadd.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("mc jpd-add", corecommon.ResolveDescription(jpdadd.GetDescription(), jpdadd.GetAIDescription()), jpdadd.Usage),
		...
		},
		{
			...
			Usage:        corecommon.ResolveDescription(jpddelete.GetDescription(), jpddelete.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("mc jpd-delete", corecommon.ResolveDescription(jpddelete.GetDescription(), jpddelete.GetAIDescription()), jpddelete.Usage),
