...
func AcquireLicense(bucketId string, name string, mcDetails *config.MissionControlDetails) error {
	postContent := AcquireLicenseRequestContent{
		Name:         name,
		LicenseCount: 1,
	}
...
type AcquireLicenseRequestContent struct {
