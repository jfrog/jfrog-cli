...
func initPipenvTest(t *testing.T) {
	...
	require.True(t, isRepoExist(tests.PypiRemoteRepo2), "Pypi test remote repository doesn't exist.")
	require.True(t, isRepoExist(tests.PypiVirtualRepo2), "Pypi test virtual repository doesn't exist.")
}
