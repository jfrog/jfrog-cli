...
import (
	...
	"github.com/jfrog/jfrog-cli/docs/bintray/downloadver"
	entitlementsdocs "github.com/jfrog/jfrog-cli/docs/bintray/entitlements"
	...
	"github.com/jfrog/jfrog-cli/docs/bintray/packageupdate"
	streamdocs "github.com/jfrog/jfrog-cli/docs/bintray/stream"
	uploaddocs "github.com/jfrog/jfrog-cli/docs/bintray/upload"
	"github.com/jfrog/jfrog-cli/docs/bintray/urlsign"
	"github.com/jfrog/jfrog-cli/docs/bintray/versioncreate"
	"github.com/jfrog/jfrog-cli/docs/bintray/versiondelete"
...
func GetCommands() []cli.Command {
	return []cli.Command{
		...
		},
		{
			...
			Aliases:      []string{"u"},
			Description:  uploaddocs.Description,
		...
		},
		{
			...
			Aliases:      []string{"dlv"},
			Description:  downloadver.Description,
		...
		},
		{
			...
			Flags:        getFlags(),
			Aliases:      []string{"ps"},
			Description:  packageshow.Description,
		...
		},
		{
			...
			Aliases:      []string{"pc"},
			Description:  packagecreate.Description,
		...
		},
		{
			...
			Flags:        getCreateAndUpdatePackageFlags(),
			Aliases:      []string{"pu"},
			Description:  packageupdate.Description,
		...
		},
		{
			...
			Aliases:      []string{"pd"},
			Description:  packagedelete.Description,
		...
		},
		{
			...
			Flags:        getFlags(),
			Aliases:      []string{"vs"},
			Description:  versionshow.Description,
		...
		},
		{
			...
			Flags:        getDeletePackageAndVersionFlags(),
			Aliases:      []string{"vd"},
			Description:  versiondelete.Description,
		...
		},
		{
			...
			Flags:        getFlags(),
			Aliases:      []string{"vp"},
			Description:  versionpublish.Description,
		...
		},
		{
			...
			Aliases:      []string{"ent"},
			Description:  entitlementsdocs.Description,
		...
		},
		{
			...
			Description:  accesskeysdoc.Description,
		...
		},
		{
			...
			Aliases:      []string{"us"},
			Description:  urlsign.Description,
		...
		},
		{
			...
			Aliases:      []string{"gsf"},
			Description:  gpgsignfile.Description,
		...
		},
		{
			...
			Flags:        getFlags(),
			Aliases:      []string{"l"},
			Description:  logsdocs.Description,
		...
		},
		{
			...
			Aliases:      []string{"st"},
			Description:  streamdocs.Description,
		...
		},
		{
			...
			Aliases:      []string{"mcs"},
			Description:  msdocs.Description,
