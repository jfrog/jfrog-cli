...
require github.com/jedib0t/go-pretty/v6 v6.4.0 // indirect; indirect, Should not be updated to v6.4.1+ due to a bug (https://github.com/jfrog/jfrog-cli-core/pull/1045)
