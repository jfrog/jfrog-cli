...
require (
	...
	github.com/jfrog/jfrog-client-go v0.11.1
...
replace github.com/jfrog/jfrog-client-go => github.com/jfrog/jfrog-client-go v0.11.2-0.20200613112804-bf1bde999b53
