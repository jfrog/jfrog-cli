...
replace github.com/jfrog/jfrog-client-go => github.com/talarian1/jfrog-client-go xray-graph-scanning

replace github.com/jfrog/jfrog-cli-core => github.com/talarian1/jfrog-cli-core xray-scan
