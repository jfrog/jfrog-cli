...
replace github.com/jfrog/jfrog-client-go => github.com/asafgabai/jfrog-client-go remote-search

replace github.com/jfrog/jfrog-cli-core => github.com/asafgabai/jfrog-cli-core remote-search
