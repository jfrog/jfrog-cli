...
replace github.com/jfrog/jfrog-client-go => github.com/gailazar300/jfrog-client-go v0.18.1-0.20210413100935-cc9831f340b3

replace github.com/jfrog/jfrog-cli-core => github.com/jfrog/jfrog-cli-core v1.5.3
