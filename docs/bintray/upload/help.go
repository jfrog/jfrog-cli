...
`	source path
	...
	target location
		The second argument specifies the root location within the repository for upload in Bintray.
	...
	target path
		[Optional]
		This third optional argument lets you specify a path under the root location to where the files should be uploaded.
