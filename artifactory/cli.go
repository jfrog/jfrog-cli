...
func GetCommands() []cli.Command {
	return cliutils.GetSortedCommands(cli.CommandsByName{
		...
		},
		{
			...
			Aliases:      []string{"ptt"},
			Usage:        corecommon.ResolveDescription(permissiontargettemplate.GetDescription(), permissiontargettemplate.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("rt ptt", corecommon.ResolveDescription(permissiontargettemplate.GetDescription(), permissiontargettemplate.GetAIDescription()), permissiontargettemplate.Usage),
		...
		},
		{
			...
			Usage:        corecommon.ResolveDescription(permissiontargetcreate.GetDescription(), permissiontargetcreate.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("rt ptc", corecommon.ResolveDescription(permissiontargetcreate.GetDescription(), permissiontargetcreate.GetAIDescription()), permissiontargetcreate.Usage),
		...
		},
		{
			...
			Usage:        corecommon.ResolveDescription(permissiontargetupdate.GetDescription(), permissiontargetupdate.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("rt ptu", corecommon.ResolveDescription(permissiontargetupdate.GetDescription(), permissiontargetupdate.GetAIDescription()), permissiontargetupdate.Usage),
		...
		},
		{
			...
			Usage:        corecommon.ResolveDescription(permissiontargetdelete.GetDescription(), permissiontargetdelete.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("rt ptdel", corecommon.ResolveDescription(permissiontargetdelete.GetDescription(), permissiontargetdelete.GetAIDescription()), permissiontargetdelete.Usage),
		...
		},
		{
			...
			Usage:        corecommon.ResolveDescription(usercreate.GetDescription(), usercreate.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("rt user-create", corecommon.ResolveDescription(usercreate.GetDescription(), usercreate.GetAIDescription()), usercreate.Usage),
			ArgsUsage:    common.CreateEnvVars(),
			BashComplete: corecommon.CreateBashCompletionFunc(),
		...
		},
		{
			...
			Usage:        corecommon.ResolveDescription(userscreate.GetDescription(), userscreate.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("rt uc", corecommon.ResolveDescription(userscreate.GetDescription(), userscreate.GetAIDescription()), userscreate.Usage),
			ArgsUsage:    common.CreateEnvVars(),
			BashComplete: corecommon.CreateBashCompletionFunc(),
		...
		},
		{
			...
			Usage:        corecommon.ResolveDescription(usersdelete.GetDescription(), usersdelete.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("rt udel", corecommon.ResolveDescription(usersdelete.GetDescription(), usersdelete.GetAIDescription()), usersdelete.Usage),
		...
		},
		{
			...
			Usage:        corecommon.ResolveDescription(groupcreate.GetDescription(), groupcreate.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("rt gc", corecommon.ResolveDescription(groupcreate.GetDescription(), groupcreate.GetAIDescription()), groupcreate.Usage),
		...
		},
		{
			...
			Usage:        corecommon.ResolveDescription(groupaddusers.GetDescription(), groupaddusers.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("rt gau", corecommon.ResolveDescription(groupaddusers.GetDescription(), groupaddusers.GetAIDescription()), groupaddusers.Usage),
		...
		},
		{
			...
			Usage:        corecommon.ResolveDescription(groupdelete.GetDescription(), groupdelete.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("rt gdel", corecommon.ResolveDescription(groupdelete.GetDescription(), groupdelete.GetAIDescription()), groupdelete.Usage),
		...
		},
		{
			...
			Usage:        corecommon.ResolveDescription(transfersettings.GetDescription(), transfersettings.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("rt transfer-settings", corecommon.ResolveDescription(transfersettings.GetDescription(), transfersettings.GetAIDescription()), transfersettings.Usage),
			ArgsUsage:    common.CreateEnvVars(),
			BashComplete: corecommon.CreateBashCompletionFunc(),
		...
		},
		{
			...
			Usage:        corecommon.ResolveDescription(transferconfig.GetDescription(), transferconfig.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("rt transfer-config", corecommon.ResolveDescription(transferconfig.GetDescription(), transferconfig.GetAIDescription()), transferconfig.Usage),
		...
		},
		{
			...
			Usage:        corecommon.ResolveDescription(transferconfigmerge.GetDescription(), transferconfigmerge.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("rt transfer-config-merge", corecommon.ResolveDescription(transferconfigmerge.GetDescription(), transferconfigmerge.GetAIDescription()), transferconfigmerge.Usage),
		...
		},
		{
			...
			Usage:        corecommon.ResolveDescription(transferfiles.GetDescription(), transferfiles.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("rt transfer-files", corecommon.ResolveDescription(transferfiles.GetDescription(), transferfiles.GetAIDescription()), transferfiles.Usage),
		...
		},
		{
			...
			Usage:        corecommon.ResolveDescription(transferplugininstall.GetDescription(), transferplugininstall.GetAIDescription()),
			HelpName:     corecommon.CreateUsage("rt transfer-plugin-install", corecommon.ResolveDescription(transferplugininstall.GetDescription(), transferplugininstall.GetAIDescription()), transferplugininstall.Usage),
