...
func CreateBuildConfig(global bool) error {
	...
	configFilePath := filepath.Join(projectDir, "nuget.yaml")
	if err := prompt.VerifyConfigFile(configFilePath); err != nil {
		return err
	}

	var vConfig *viper.Viper
	configResult := &NugetBuildConfig{}
	configResult.Version = prompt.BUILD_CONF_VERSION
	configResult.ConfigType = utils.Nuget.String()
	...
	log.Info("Nuget install config successfully created.")
	return nil

}

type NugetBuildConfig struct {
