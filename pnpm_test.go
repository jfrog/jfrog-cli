...
func TestPnpmInstallAndPublishNormalProject(t *testing.T) {
	...
	err = createConfigFileForTest([]string{projectDir}, tests.NpmRemoteRepo, tests.NpmRepo, t, project.Pnpm, false)
	assert.NoError(t, err)
...
func initPnpmFilesTest(t *testing.T) (pnpmProjectPath, pnpmScopedProjectPath string) {
	...
	err := createConfigFileForTest([]string{filepath.Dir(pnpmProjectPath), filepath.Dir(pnpmScopedProjectPath)},
		tests.NpmRemoteRepo, tests.NpmRepo, t, project.Pnpm, false)
	assert.NoError(t, err)
...
func initPnpmWorkspaceTest(t *testing.T) (pnpmWorkspacePath string) {
	...
	err := createConfigFileForTest([]string{pnpmWorkspacePath}, tests.NpmRemoteRepo, tests.NpmRepo, t, project.Pnpm, false)
	assert.NoError(t, err)
